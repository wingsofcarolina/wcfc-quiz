...
public class ExclusionGroup {
	...
	public String toString() {
		return "ExclusionGroup [groupId=" + groupId + ", groupName=" + name + ", createdDate=" + createdDate
	...
	public static List<ExclusionGroup> getAllGroups() {
		ExclusionGroupDAO exclusionGroupDAO = (ExclusionGroupDAO) Persistence.instance().get(ExclusionGroup.class);
