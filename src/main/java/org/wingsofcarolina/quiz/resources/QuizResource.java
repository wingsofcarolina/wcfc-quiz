...
public class QuizResource {
  ...
  @GET
  @Path("version")
  public Response versionInformation(@CookieParam("quiz.token") Cookie cookie)
    ...
    if (cookie != null) {
      ...
      String rendered = renderer
        .render("version.ad", new JsonWrapper(user, output))
        .toString();
  ...
  @GET
  @Path("gallery")
  public Response gallery(@CookieParam("quiz.token") Cookie cookie)
    throws AuthenticationException, IOException {
    if (cookie != null) {
      Jws<Claims> claims = authUtils.validateUser(cookie.getValue(), Privilege.USER);
      User user = User.getWithClaims(claims);
  ...
  @Path("showUsers")
  @Produces("text/html")
  public Response showUsers(@CookieParam("quiz.token") Cookie cookie)
    throws Exception, AuthenticationException {
    String output = "";
    if (cookie != null) {
      Jws<Claims> claims = authUtils.validateUser(cookie.getValue());
  ...
  @Path("profile")
  @Produces("text/html")
  public Response profile(@CookieParam("quiz.token") Cookie cookie)
    throws Exception, AuthenticationException {
    if (cookie != null) {
      Jws<Claims> claims = authUtils.validateUser(cookie.getValue());
      User user = User.getWithClaims(claims);
  ...
  @Path("generate/{alias}")
  @Produces("text/html")
  public Response generate(@PathParam("alias") String alias) throws Exception {
    Recipe recipe = null;
    Quiz quiz = null;
  ...
  public Response previewQuestion(
    ...
    if (cookie != null) {
      ...
      if (question != null) {
        ...
        Flash.add(
          Flash.Code.ERROR,
          "Requested question \"" + questionId + "\" not found."
        );
        NewCookie newCookie = authUtils.generateCookie(user);
  ...
  public Response previewKey(
    ...
    if (cookie != null) {
      ...
      try {
        ...
        Flash.add(
          Flash.Code.ERROR,
          "Invalid question ID \"" + questionId + "\" entered."
        );
        NewCookie newCookie = authUtils.generateCookie(user);
        return new RedirectResponse(Pages.HOME_PAGE)
          .header("Set-Cookie", AuthUtils.sameSite(newCookie))
  ...
  @Produces("text/html")
  public Response reportAttribute(
    @CookieParam("quiz.token") Cookie cookie,
    @PathParam("attribute") String attribute,
    @QueryParam("alphabetical") Boolean alphabetical,
    @QueryParam("superseded") Boolean superseded
  ) throws AuthenticationException, IOException {
    ...
    if (cookie != null) {
      ...
      AttributeReportWrapper wrapper = new AttributeReportWrapper(
        user,
        questions,
        attribute
      );
  ...
  @Produces("text/html")
  public Response reportCategory(
    @CookieParam("quiz.token") Cookie cookie,
    ...
    if (cookie != null) {
      ...
      CategoryReportWrapper wrapper = new CategoryReportWrapper(
        user,
        questions,
        category
      );
  ...
  @Produces("text/html")
  public Response quarantinedReport(@CookieParam("quiz.token") Cookie cookie)
    throws AuthenticationException, IOException {
    if (cookie != null) {
      Jws<Claims> claims = authUtils.validateUser(cookie.getValue(), Privilege.USER);
      User user = User.getWithClaims(claims);
  ...
  @Path("recordReport")
  @Produces("text/html")
  public Response recordReport(@CookieParam("quiz.token") Cookie cookie)
    throws AuthenticationException, IOException {
    if (cookie != null) {
      Jws<Claims> claims = authUtils.validateUser(cookie.getValue(), Privilege.USER);
      User user = User.getWithClaims(claims);
  ...
  @Produces("text/html")
  public Response chartAttribute(
    @CookieParam("quiz.token") Cookie cookie,
    @PathParam("attribute") String attribute
  ) throws AuthenticationException, IOException {
    if (cookie != null) {
      ...
      AttributeChartWrapper wrapper = new AttributeChartWrapper(
        user,
        questions,
        attribute
      );
  ...
  @Produces("application/pdf")
  public Response allQuestionsWithAttribute(
    @CookieParam("quiz.token") Cookie cookie,
    @PathParam("attribute") String attribute
    ...
    if (cookie != null) {
      ...
      if (questions != null) {
        ...
        Flash.add(
          Flash.Code.ERROR,
          "Questions with requested attribute \"" + attribute + "\" not found."
        );
        NewCookie newCookie = authUtils.generateCookie(user);
        return new RedirectResponse(Pages.HOME_PAGE)
          .header("Set-Cookie", AuthUtils.sameSite(newCookie))
  ...
  @Produces("application/pdf")
  public Response allQuestionsInCategory(
    @CookieParam("quiz.token") Cookie cookie,
    @PathParam("category") String category
  ) throws AuthenticationException, IOException, QuizBuildException, URISyntaxException {
    if (cookie != null) {
      ...
      if (questions != null) {
        ...
        Flash.add(
          Flash.Code.ERROR,
          "Questions in requested category \"" + category + "\" not found."
        );
        NewCookie newCookie = authUtils.generateCookie(user);
        return new RedirectResponse(Pages.HOME_PAGE)
          .header("Set-Cookie", AuthUtils.sameSite(newCookie))
  ...
  public Response showRecipe(
    ...
    if (cookie != null) {
      ...
      if (recipe != null) {
        ...
        String rendered = renderer
          .render("recipe.ad", new JsonWrapper(user, output))
          .toString();
        NewCookie newCookie = authUtils.generateCookie(user);
        return Response
          .ok()
  ...
  @Produces("text/html")
  public Response browseFirstQuestions(@CookieParam("quiz.token") Cookie cookie)
    throws Exception, AuthenticationException {
  ...
  @Produces("text/html")
  public Response browseNextQuestions(
    @CookieParam("quiz.token") Cookie cookie,
    @PathParam("skip") Integer skip
  ) throws Exception, AuthenticationException {
  ...
  @Path("browseQuestions")
  @Produces("text/html")
  public Response browseQuestionsSkip(
    @CookieParam("quiz.token") Cookie cookie,
  ...
  public Response browseQuestions(Cookie cookie, Integer skip)
    throws Exception, AuthenticationException {
    if (cookie != null) {
      Jws<Claims> claims = authUtils.validateUser(cookie.getValue(), Privilege.ADMIN);
      User user = User.getWithClaims(claims);
  ...
  @Produces("text/html")
  public Response searchFirstQuestions(@CookieParam("quiz.token") Cookie cookie)
    throws Exception, AuthenticationException {
  ...
  public Response searchQuestions(
    ...
    @FormParam("case") Boolean caseSensitive
  ) throws Exception, AuthenticationException {
    if (cookie != null) {
      Jws<Claims> claims = authUtils.validateUser(cookie.getValue(), Privilege.ADMIN);
      User user = User.getWithClaims(claims);
        ...
        if (search != null && !search.isEmpty()) {
          ...
          for (Question question : candidates) {
            if (compareCase(question.getQuestion(), search, caseSensitive)) {
              ...
              compareCase(question.getCategory().name(), search, caseSensitive)
            ) {
              questions.add(question);
            }
          }
    ...
    if (cookie != null) {
      ...
      if (user != null && question != null) {
        ...
        return Response
          .ok()
          .entity(output)
          .cookie(authUtils.generateCookie(user, question.getQuestionId()))
          .build();
      } else {
