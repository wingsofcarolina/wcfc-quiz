...
public class AuthUtils {
  ...
  public Jws<Claims> validateCookie(Cookie cookie, Privilege admin)
  ...
  public Jws<Claims> validateUser(String compactJws, Privilege privilege)
    throws AuthenticationException {
    Jws<Claims> claims = null;
    if (compactJws != null) {
      try {
